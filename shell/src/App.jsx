...
export default function App() {
  ...
  useEffect(() => {
    // TODO: ecouter l'event 'crowd:panic'
    // Si level > 80 → cityStatus = 'crisis'
    // Si level > 40 → cityStatus = 'alert'
    // Sinon → cityStatus = 'normal'
    //
    // TODO: ecouter l'event 'hacker:command'
    // Si command = 'reset' → cityStatus = 'normal'
    //
    // N'oublie pas le cleanup des deux listeners
